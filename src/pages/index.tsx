...
export default function Home(_props: InferGetStaticPropsType<typeof getStaticProps>) {
  ...
  const welcomeword = "Hi&nbsp;<strong>" + username +"</strong> , this is ChatPDF <br /> Welcome!";
    useEffect(() => {
    ...
    <>
      ...
      <main className={styles.main}>
        <div className={styles.description}>
          { firstShow && flag &&  <div ref={writerRef} className={fadeCls + " " + opacity + " transition-all flex bg-white items-center justify-center fixed inset-0 px-2 py-2 radius-md z-50"} style={{fontSize: 75}} onTransitionEnd={()=>setDisplay()}>
          ...
          {
            flag && <div className={fontHeavyCls + " text-lg bg-white/50 px-4 py-2 rounded-lg"}>{"Hi, " + username}</div>
        ...
        <div className={styles.center}>
          <div className='flex flex-col'>
            <div className='flex'>
            <div className={fonts.sfUltralight +' ' + styles.title} style={{fontSize: '4rem', zIndex:1}}>ChatPDF</div>
          <div className={styles.thirteen + ' ' + fontCls}  style={{fontSize: '2rem'}}>
            3.5
          </div>
            </div>
          

          {flag && <div className='flex justify-center mt-2'>
